...
def make_event():
    ...
    _malicious_client = ipsum_loader.get_malicious_ip() if random.random() < _MALICIOUS_RATIO else None
    event_client_ip = ipaddress.ip_address(_malicious_client) if _malicious_client is not None else get_ip()
